...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ticket.client_id'
        db.add_column(u'ticketing_ticket', 'client_id',
                      self.gf('django.db.models.fields.CharField')(default='127.0.0.1', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ticket.client_id'
        db.delete_column(u'ticketing_ticket', 'client_id')
    ...
    models = {
        ...
        u'videostore.video': {
            ...
            'meta_info': ('django.db.models.fields.TextField', [], {'null': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ticket.headers'
        db.alter_column(u'ticketing_ticket', 'headers', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Ticket.headers'
        raise RuntimeError("Cannot reverse this migration. 'Ticket.headers' and its values cannot be restored.")

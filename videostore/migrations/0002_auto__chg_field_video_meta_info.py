...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Video.meta_info'
        db.alter_column(u'videostore_video', 'meta_info', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Video.meta_info'
        raise RuntimeError("Cannot reverse this migration. 'Video.meta_info' and its values cannot be restored.")
